...
export default function AdminReportsPage() {
  ...
  const fetchOperators = async () => {
    try {
      const data = await API.users.getAll('operator');
      setOperators(data);
    } catch (error) {
  ...
  const exportToCSV = () => {
    ...
    link.download = `report_${filters.startDate}_${filters.endDate}.csv`;
    link.click();
  };
              ...
              <CardHeader>
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  <TabsList>
                    ...
                    <TabsTrigger value="machine">{t('machineReport')}</TabsTrigger>
                    <TabsTrigger value="operator">{t('operatorReport')}</TabsTrigger>
                  </TabsList>
                </Tabs>
              </CardHeader>
              <CardContent>
